...
console.log(Math.cbrt(-125));//-5
//Math.abs
console.log(Math.abs(-4.5));//4
console.log(Math.abs(-5.8));//5
console.log(Math.abs(-6.4));//6
//Math.trunc
console.log(Math.trunc(4.5));//4
console.log(Math.trunc(4.8));//4
console.log(Math.trunc(-4.4));//-4
//Math.min
console.log(Math.min(3,25,49,-3,-18));//3
//Math.max
console.log(Math.max(3,25,49,3.28,-3,-18));//49
//Math.pow
var a = 2;
